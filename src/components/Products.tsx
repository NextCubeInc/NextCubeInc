...
import { Link, Cog, ArrowUpRight, Pyramid } from "lucide-react";
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product, index) => (
            <SpotlightCard 
            className="custom-spotlight-card hover-lift group cursor-pointer border-border/50 bg-background"
            spotlightColor="rgba(186, 85, 211, 0.2)"
          >
            <CardHeader>
